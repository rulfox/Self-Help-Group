            ...
            SelfHelpGroupTheme {
                Surface(color = MaterialTheme.colors.background) {
                    ...
                    NavHost(
                        ...
                        composable(route = Screen.AddThriftScreen.route.plus("/{$NAV_ARG_COMMITTEE_ID}"), arguments = listOf(navArgument(NAV_ARG_COMMITTEE_ID) {
                        ...
                        composable(route = Screen.CommitteeListingScreen.route) {
                            CommitteeListingScreen(navController = navController)
                        }
                        composable(route = Screen.CommitteeDetailsScreen.route.plus("/{$NAV_ARG_COMMITTEE_ID}"), arguments = listOf(navArgument(NAV_ARG_COMMITTEE_ID) {
                            type = NavType.IntType
                        })){ backStackEntry ->
                            val committeeId = backStackEntry.arguments?.getInt(NAV_ARG_COMMITTEE_ID)
