...
class DeleteThriftUseCase @Inject constructor(private val thriftRepository: ThriftRepository) {
    suspend operator fun invoke(thrift: Thrift) = thriftRepository.deleteThrift(thrift)
}